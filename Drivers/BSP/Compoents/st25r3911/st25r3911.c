...
ReturnCode st25r3911SetRegulators( uint8_t regulation )
{
    /* Check valid setting */
    if( regulation > (ST25R3911_REG_REGULATOR_CONTROL_mask_rege>>ST25R3911_REG_REGULATOR_CONTROL_shift_rege) )
    {
        return RFAL_ERR_PARAM;
    }
   
    st25r3911ChangeRegisterBits( ST25R3911_REG_REGULATOR_CONTROL, ST25R3911_REG_REGULATOR_CONTROL_mask_rege, (regulation<<ST25R3911_REG_REGULATOR_CONTROL_shift_rege) );
